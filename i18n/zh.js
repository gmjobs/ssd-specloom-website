...
(function () {
  ...
  NS.dict.zh = {
    ...
    show: {
      alt: "示意：一份 spec.md 规格，AI 据此派生出原型、技术方案、代码、测试与追溯映射",
      winTag: "Specloom",
      specTitle: "需求：邮箱登录",
    ...
    flow: {
      ...
      lede: "人类零散纠缠的需求与想法送进来，Specloom 以规格为织机，逐道工序编织出干净、可追溯的交付物。",
      reqLabel: "需求与想法",
      assetLabel: "可交付物",
      brandSub: "规格即织机 · 自动编织交付",
      req: { r1: "想法", r2: "一句话需求", r3: "澄清对话", r4: "规格草稿", r5: "验收点" },
      asset: { a1: "规格", a2: "原型", a3: "技术方案", a4: "代码", a5: "测试", a6: "发布" },
    },
    ...
    what: {
      ...
      cards: [
        ...
        },
        {
          icon: "ai",
          title: "AI 产出全部产物",
          desc: "规格、可交互原型、技术方案、代码、测试、追溯映射——每道工序该产出的，AI 据规格一次到位，而非外挂式补全。",
        },
        {
          icon: "verify",
          title: "双轮校验，防 AI 幻觉",
          desc: "代码生成后可派独立 Agent 回看，核对引用的符号、依赖、契约是否真实存在，把「看起来对」的幻觉挡在落盘之前。",
        },
        {
          icon: "model",
          title: "用你自己的模型",
        ...
        },
        {
          icon: "trace",
          title: "全程可追溯、可审计",
          desc: "需求 ↔ 代码 ↔ 测试 的追溯映射，产物记录血缘与来源；每一次门禁审批都挂靠在规格上，破除 AI 代码黑盒。",
        },
        {
          icon: "local",
          title: "数据留在你的仓库",
    ...
    steps: {
      ...
      s1: {
        title: "描述需求",
        desc: "写下标题与一句话需求，AI 起草结构化规格，并生成一份可点击的交互原型供评审。",
      },
      s2: {
        title: "按档评审",
